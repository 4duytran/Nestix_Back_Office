...
if(isset($_POST['search']) && !empty($_POST['search']))
{
    if(isset($_POST['csrf']) && hash_equals($_SESSION['token'], $_POST['csrf']))
    {
        ...
        $totalMedia = (int)countAllMusic($search); // count total row of sql request
...
{
    $totalMedia = (int)countAllMusic(); // count total row of sql request
