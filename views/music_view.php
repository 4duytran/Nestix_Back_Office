      ...
      <div class="col-md-12 col-lg-12">
        ...
        <table class="table table-striped table-dark table-bordered text-white" id="example">
          <tr>
            ...
            <th scope="col">Media Poster</th>
            <th scope="col">Media Name</th>
            <th scope="col">Media Year</th>
            <th scope="col">Media Genre</th>
          ...
          <tr>
            ...
            <td><img src="assets/files/<?= $media->m_poster ?>" class="img-icon" alt="" /></td>  
            <td><?= $media->m_name ?></td>
            <td><?= $media->m_year ?></td>
            <td><?= $media->m_genre ?></td>
            <td><?= $media->m_type ?></td>
        ...
        <nav aria-label="Page navigation">
          <ul class="pagination justify-content-center">
            <li class="page-item <?= $previous>=1 ? '' : 'disabled'; ?>">
              <a class="page-link" href="music?nb=<?= $previous>=1 ? $previous : 1; ?>" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            <?php for( $i=1; $i<=$paginations; $i++ ): ?>
            <li class="page-item <?= $i == $pagination ? 'active' : ''; ?>"><a class="page-link" href="music?nb=<?= $i; ?>"><?= $i; ?></a></li>
            <?php endfor; ?>
            <li class="page-item <?= $next <= $paginations ? '' : 'disabled'; ?>">
              <a class="page-link" href="music?nb=<?= $next <= $paginations ? $next : $paginations; ?>">Next</a>
            </li>
          </ul>
        </nav>
