        ...
        <nav aria-label="Page navigation">
          <ul class="pagination justify-content-center">
            <li class="page-item <?= $previous>=1 ? '' : 'disabled'; ?>">
              <a class="page-link" href="film?nb=<?= $previous>=1 ? $previous : 1; ?>" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            <?php for( $i=1; $i<=$paginations; $i++ ): ?>
            <li class="page-item <?= $i == $pagination ? 'active' : ''; ?>"><a class="page-link" href="film?nb=<?= $i; ?>"><?= $i; ?></a></li>
            <?php endfor; ?>
            <li class="page-item <?= $next <= $paginations ? '' : 'disabled'; ?>">
              <a class="page-link" href="film?nb=<?= $next <= $paginations ? $next : $paginations; ?>">Next</a>
            </li>
          </ul>
        </nav>
